...
class ClassMetadata
{
	...
	/**
	 * Add info for an XML AnyElement
	 * 
	 * @param string $name
	 * @param string $property
	 */
	public function addAnyElement($name, $property, $list)
	{
		$this->anyElements[$name] = array($property,$list);
	}

	/**
	 * Get all of the XML AnyElements
	 * 
	 * @return array
	 */
