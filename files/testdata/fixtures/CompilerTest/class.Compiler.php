 ...
 * 
 * @TODO inline Kommentare , die in keinem DocComment oder Body stehen werden verschluckt
...
class CompilerTestFixture extends \Psc\Object {
  ...
  public function compile(File $out, $flags = 0) { // 0x000000 geht leider noch nicht
    ...
    $this->classWriter->setClassFromReader($this->classReader);
