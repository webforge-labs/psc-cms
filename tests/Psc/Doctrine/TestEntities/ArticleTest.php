...
/**
 * ACHTUNG: Dies ist kein richtiger Test, sondern eher eine Spielwiese für das Ausprobieren von Associations
 *
 * 
 * @group class:Psc\Doctrine\TestEntities\Article
 * @group experiment
 */
class ArticleTest extends \Psc\Doctrine\DatabaseTestCase {
  ...
  public function setUp() {
    ...
    $this->tagRepository = $this->em->getRepository('Psc\Doctrine\TestEntities\Tag');
