...
class TabButtonTest extends \Psc\Code\Test\HTMLTestCase {
  ...
  public function setUp() {
    ...
    $this->jooseBridge = $this->getMock('Psc\CMS\Item\JooseBridge', array('link','autoLoad','html'), array($this->item));
  ...
  public function testAcceptance() {
    ...
    $this->jooseBridge->expects($this->once())->method('html')
                      ->will($this->returnValue('the html'));
    
    $this->html = $this->tabButton->html();
    $this->assertEquals('the html', $this->html);
  }
}
?>