...
class RequestConverterTest extends \Psc\Code\Test\Base {
  ...
  public function testMultiPartHTTPRequetsDataConversionIntoFiles() {
    ...
    $request
      ...
      ->setFiles(array('uploadFile'=>\Psc\System\File::createTemporary())); // das würde der HTTPRequest schona lles bei infer() checken
    ...
    $this->assertInstanceOf('Psc\System\File', $files['uploadFile']);
