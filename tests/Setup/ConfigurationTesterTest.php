...
/**
 * @group class:Psc\Setup\ConfigurationTester
 */
class ConfigurationTesterTest extends \Psc\Code\Test\Base {
  ...
  public function testWrongIniValuesAreGatheredWithinDefects() {
    ...
    $this->assertInstanceOf('Psc\Setup\IniConfigurationDefect', $iniDefect = $defects[0]);
  ...
  protected function debugDefects() {
    return \Psc\A::join($this->t->getDefects(), "%s\n");
  }
}
?>