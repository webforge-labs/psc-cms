...
class PHPWord_Writer_Word2007 implements PHPWord_Writer_IWriter {
	...
	public function save($pFilename = null) {
		if(!is_null($this->_document)) {
            ...
            // Write static files
			$objZip->addFromString('word/numbering.xml', file_get_contents(PHPWORD_BASE_PATH . 'PHPWord/_staticDocParts/numbering.xml'));
			$objZip->addFromString('word/settings.xml', file_get_contents(PHPWORD_BASE_PATH . 'PHPWord/_staticDocParts/settings.xml'));
            $objZip->addFromString('word/theme/theme1.xml', file_get_contents(PHPWORD_BASE_PATH . 'PHPWord/_staticDocParts/theme1.xml'));
			$objZip->addFromString('word/webSettings.xml', file_get_contents(PHPWORD_BASE_PATH . 'PHPWord/_staticDocParts/webSettings.xml'));
			$objZip->addFromString('word/fontTable.xml', file_get_contents(PHPWORD_BASE_PATH . 'PHPWord/_staticDocParts/fontTable.xml'));
