...
class ClassMetadataFactory
{
   ...
   */
  public function __construct(AnnotationLoader $loader, Cache $cache = null, $defaultNamespace = NULL)
  {
    $this->loader = $loader;
    $this->loader->setMetadataFactory($this);
    $this->cache = $cache;
  ...
  public function getClassMetadata($class)
  {
    ...
    if (mb_strpos($class,'\\') === FALSE && $this->defaultNamespace != NULL) {
  ...
  public function setDefaultNamespace($ns = NULL) {
