 ...
 * @ORM\DiscriminatorMap({"headline" = "Headline", "paragraph" = "Paragraph", "image" = "Image", "simpleteaser" = "SimpleTeaser", "teaser-headline-image-text-link" = "TeaserHeadlineImageTextLink"})
 */
